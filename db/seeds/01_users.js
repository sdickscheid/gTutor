  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {first_name: 'Hassan', last_name: 'Khan', email: 'h@ssan.com', password: '$2a$10$IbOrl5w2ngI54Fq.k6OuYOJCuN3bAyFX9rjJHweh68lgfl82swLwm', cohort: 'g58', campus: 'Phoenix', type: 'Student', role: 'user'},
